  ...
  risk_clauses: [
    {
      ...
      legal_basis:
        '《住宅租賃定型化契約應記載及不得記載事項》應記載事項 五：' +
        '押金最高不得超過二個月租金之總額。',
      negotiation_script:
        '「房東您好，我看到合約上寫押金是四個月，不過根據法規，押金上限是兩個月租金喔，' +
    ...
    },
    {
      ...
      legal_basis:
        '《住宅租賃定型化契約應記載及不得記載事項》應記載事項 六：' +
        '電費若按度計費，每度不得超過台電電費單之「當期每度平均電價」。',
      negotiation_script:
        '「房東您好，合約上電費寫每度 6 元，但依據法規，電費不能超過台電帳單上的每度平均電價。' +
    ...
    },
    {
      ...
      legal_basis:
        '《住宅租賃定型化契約應記載及不得記載事項》不得記載事項 三、' +
        '《住宅租賃定型化契約應記載及不得記載事項》不得記載事項 四。',
      negotiation_script:
        '「房東您好，合約中關於不能遷戶籍和不能申報租金費用這兩點，根據法規都是不能寫進合約的條款，' +
